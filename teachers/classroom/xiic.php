...
<body>
    <div class="page-header">
        <h1>Hi, <b><?php echo htmlspecialchars($_SESSION["usernamet"]); ?></b>. Welcome to our site.</h1>
    </div>
    <p>
    ...
    <div>
     ...
     <?php
     include("config.php");
     $fetchVideos = mysqli_query($con, "SELECT id, student_name, location, location2 FROM xiictud ORDER BY id ASC");
